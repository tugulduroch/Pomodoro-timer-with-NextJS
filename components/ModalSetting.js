		...
		<>
			...
			>
				<div className="text-gray-400 flex justify-between items-center">
					<h1 className="uppercase font-bold tracking-wider">Тохиргоо</h1>
					<FiX
				...
				<div className="flex gap-5">
					{inputs.map((input, index) => {
						return (
							<div key={index}>
								<h1 className="text-gray-400 text-sm pb-2">{input.value}</h1>
								<input
				...
				<button
					className="bg-cyan-500 w-full mt-5 text-white rounded py-2"
